<div align="center">
  ...
  <!-- Animated Capsule Divider Header -->
...
<details open>
  <summary><b>🏢 Sistema de Automatización EL ORBE</b> <i>(Haz clic para replegar)</i></summary>
  <br>
  <blockquote>
...
<details>
  ...
  <blockquote>
    ...
    🛠️ <b>Tech Stack:</b> <code>REST APIs</code> • <code>Laravel 12</code> • <code>React</code><br>
...
* 🧩 **Pensamiento Analítico & Problem Solving:** Capacidad para descomponer problemas complejos en soluciones técnicas eficientes.
* 🤝 **Trabajo en Equipo (Co-Op):** Comunicación clara, adaptación a metodologías ágiles y colaboración efectiva.
* ⚡ **Fast Learner & Adaptabilidad:** Asimilación veloz de nuevas herramientas e integración de soluciones basadas en IA.
* 🎯 **Business Agility:** Enfoque orientado a aportar valor real a la lógica de negocio corporativa.
